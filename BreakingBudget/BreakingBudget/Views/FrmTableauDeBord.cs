...
{
    public partial class FrmTableauDeBord : MetroForm
    {
        ...
        private void SaveTableEnLocal(string nomTable)
        {
            ...
            {
                MessageBox.Show("Erreur dans la requête SQL", "Erreur Base de donnée", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            catch (InvalidOperationException)
            {
                MessageBox.Show("Erreur de connexion à la base !", "Erreur Base de donnée", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
        ...
        private void supprimerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message);
                // On annule la transaction en cas d'erreurs
                transac.Rollback();
            }
            finally
            {
